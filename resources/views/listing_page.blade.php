			                ...
			                <form class="forms-sample" method="post" action="{{route('newreg')}}">
			                	...
			                	<div class="card-header">
				                  	...
				                  	<ul class="nav nav-justified">
			                            <li class="nav-item">
			                                <a role="tab" class="nav-link active tab-switch show" id="tab-0" data-toggle="tab" href="#tab-content-0">
			                                    <span>Customer Details</span>
			                                </a>
			                            </li>
			                            <li class="nav-item">
			                                <a role="tab" class="nav-link tab-switch" id="tab-1" data-toggle="tab" href="#tab-content-1">
			                                    <span>Finance details</span>
			                                </a>
			                            </li>
			                            <li class="nav-item">
			                                <a role="tab" class="nav-link tab-switch" id="tab-2" data-toggle="tab" href="#tab-content-2">
			                                    <span>Initial Payment details</span>
			                                </a>
			                            </li>
			                            <li class="nav-item">
			                                <a role="tab" class="nav-link tab-switch" id="tab-3" data-toggle="tab" href="#tab-content-3">
			                                    <span>Others</span>
			                                </a>
			                            </li>
			                        </ul>
					                  	...
					                  	<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="vehicle_number" placeholder="Vehicle Number" name="vehicle_number">
							                    </div>
					                  		</div>
					                  	</div>
					                  	<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="chassis_no" placeholder="Chassis Number" name="chassis_no">
							                    </div>
					                  		</div>
					                  		<div class="col-md-6">
							                    <div class="form-group">
	                            		...
	                            		<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="contract_period" placeholder="No of months" name="contract_period">
							                    </div>
											...
											<div class="col-md-6">
												<div class="form-group">
											      	...
											      	<input type="text" class="form-control" id="vehicle_cost" placeholder="Cost of vehicle" name="vehicle_cost">
											    </div>
											</div>
					                  	</div>
	                            		<div class="row">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
											      	...
											      	<input type="text" class="form-control" id="interest" placeholder="Interest" name="interest">
											    </div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
	                            		...
	                            		<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="cost_difference" placeholder="Difference in cost" name="cost_difference">
							                    </div>
											...
											<div class="col-md-6">
												<div class="form-group">
											      	...
											      	<input type="text" class="form-control" id="caution_deposit" placeholder="Caution deposit" name="caution_deposit">
											    </div>
											</div>
					                  	</div>
					                  	<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="current_insurance" placeholder="Current year Insurance" name="current_insurance">
							                    </div>
											...
											<div class="col-md-6">
												<div class="form-group">
											      	...
											      	<input type="text" class="form-control" id="rto_expense" placeholder="RTO Expenses" name="rto_expense">
											    </div>
											</div>
					                  	</div>
					                  	<div class="row">
					                  		<div class="col-md-6">
							                    <div class="form-group">
							                      ...
							                      <input type="text" class="form-control" id="total_other" placeholder="Total amount" name="total_other">
							                    </div>
	                            		...
	                            		<div class="row">
					                  		<div class="col-md-12">
							                    <div class="form-group row">
							                      	...
							                      	<div class="col-md-9">
							                      		<input type="text" class="form-control" id="reg_date" placeholder="R. No & date" name="reg_date">
							                      	</div>
							                    </div>
					                  		</div>
					                  	</div>
					                  	<div class="row">
					                  		<div class="col-md-12">
							                    <div class="form-group row">
							                      	...
							                      	<div class="col-md-9">
							                      		<input type="text" class="form-control" id="dealer_name" placeholder="Dealer Name" name="dealer_name">
							                      	</div>
							                    </div>
					                  		</div>
					                  	</div>
					                  	<div class="row">
					                  		<div class="col-md-12">
							                    <div class="form-group row">
							                      	<label for="cheque_no" class="col-md-3">Cheque No.</label>
							                      	<div class="col-md-9">
